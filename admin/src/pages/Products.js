              ...
              <tr key={p._id}>
                {editingProduct === p._id ? (
                  <>
                    ...
                    <td>{p.status}</td>
                    <td>
                      <button onClick={() => updateProduct(p._id)} className="save-btn">
                        Save
                      </button>
                  ...
                  <>
                    ...
                    <td>
                      {p.status === "pending" && (
                        <>
                          <button onClick={() => approveProduct(p._id)} className="approve-btn">
                            Approve
                          </button>
                          <button onClick={() => rejectProduct(p._id)} className="reject-btn">
                            Reject
                          </button>
                        </>
                      )}
